...
@ProviderRegistry.register_base_impl("reduce_max", "ComputeEngine")
...
@ProviderRegistry.register_base_impl("reduce_min", "ComputeEngine")
...
@ProviderRegistry.register_base_impl("reduce_sum", "ComputeEngine")
...
@ProviderRegistry.register_base_impl("topk", "ComputeEngine")
