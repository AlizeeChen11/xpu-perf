...
"""
@ProviderRegistry.register_base_impl("rms_norm", "ComputeEngine")
...
@ProviderRegistry.register_base_impl("layer_norm", "ComputeEngine")
...
@ProviderRegistry.register_base_impl("softmax", "ComputeEngine")
